...
void qtranslate_succinct(pugi::xml_node, ofstream &);
void qtranslate_succinct_body(pugi::xml_node, string, ofstream &);
void qtranslate_succinct_doc(pugi::xml_document &);
void qtranslate_succinct_doc_reconstructBody(pugi::xml_node &, pugi::xml_node &, vector < pugi::xml_node >);
